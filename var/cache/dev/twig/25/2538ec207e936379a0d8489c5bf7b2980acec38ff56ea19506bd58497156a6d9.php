...
class __TwigTemplate_c97891c3584a340457cfd1dc6ad8c9134909b6e8ecc502c3c6d1c688bb8c5f2d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span
        ...
        >";
        // line 16
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 16, $this->source); })()), "price", [], "any", false, false, false, 16) / 100), 2), "html", null, true);
        echo " €</span
      >
  <hr>
  <p>
...
";
    ...
    {
        return array (  120 => 20,  113 => 16,  106 => 12,  102 => 11,  94 => 8,  90 => 6,  80 => 5,  59 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'base.html.twig' %}
 {% block title %}{{product.name}} - Good Morning
{%endblock %}

 {% block content %}
 <div class=\"container row \">
     <div class=\"col-md-5 \">
     <img src=\"/uploads/files/{{product.illustration}}\" alt=\"{{product.name}}\" class=\"img-fluid\">
 </div>
     <div class=\"col-md-7 my-auto\">
      <h3>{{product.name}}</h3>
...
{% endblock %}
", "product/show.html.twig", "/Applications/MAMP/fil_rouge_good_morning/templates/product/show.html.twig");
    }
}
