...
class __TwigTemplate_0c7cba7ba74077e4169f11e69027d4187667f8532f8c3446f3974def63611c1c extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 11
            echo "      <li><a href=\"/admin\">Vous êtes un administrateur, accéder au backoffice !</a> <br/></li>
  ";
        }
        // line 13
        echo "  <hr>
 ...
 <ul>
    <li><a href=\"compte/password\">Modifier mon mot de passe</a></li>
    <li><a href=\"#\">Gérer mon adresse de livraison</a></li>
</ul>
...
";
    ...
    {
        return array (  103 => 13,  99 => 11,  97 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mon compte - Good Morning{% endblock %}
...
{% if is_granted('ROLE_ADMIN') %}
      <li><a href=\"/admin\">Vous êtes un administrateur, accéder au backoffice !</a> <br/></li>
  {% endif %}
  <hr>
 C'est dans cet espace que vous allez pouvoir gérer toutes vos informations personnelles.
 <ul>
...
{% endblock %}
", "account/index.html.twig", "/Applications/MAMP/filrouge/fil_rouge_good_morning/templates/account/index.html.twig");
    }
}
